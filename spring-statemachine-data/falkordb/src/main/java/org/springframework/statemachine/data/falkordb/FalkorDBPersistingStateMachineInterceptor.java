 ...
 */
public class FalkorDBPersistingStateMachineInterceptor<S, E, T> extends AbstractPersistingStateMachineInterceptor<S, E, T>
		implements StateMachineRuntimePersister<S, E, T> {

	private final FalkorDBRepositoryStateMachinePersist<S, E> persist;

	/**
	 * Instantiates a new falkordb persisting state machine interceptor.
	 *
	 * @param FalkorDBStateMachineRepository the falkordb state machine repository
	 */
	public FalkorDBPersistingStateMachineInterceptor(FalkorDBStateMachineRepository FalkorDBStateMachineRepository) {
		Assert.notNull(FalkorDBStateMachineRepository, "'FalkorDBStateMachineRepository' must be set");
		this.persist = new FalkorDBRepositoryStateMachinePersist<S, E>(FalkorDBStateMachineRepository);
	}
	 ...
	 */
	public FalkorDBPersistingStateMachineInterceptor(FalkorDBRepositoryStateMachinePersist<S, E> persist) {
